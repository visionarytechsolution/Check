...
export default function LayoutSettings({ children, activeState, setActiveState }) {
  const InfoData = [
    {
      id: 'profile',
      title: 'Freelancer Editor Profile',
      description: 'The information about your freelancer profile.',
      icon: PersonIcon,
    },
    {
      id: 'notification',
    ...
    },
    {
      id: 'payment',
      title: 'Payment',
      description: 'Payment history and payment mode settings.',
      icon: PaidIcon,
    },

    {
      id: 'help',
      title: 'Help',
      description: 'RealVision Help Center for Freelancers.',
      icon: HelpIcon,
    },
    // {
    //   id: "integration",
    ...
    {
      id: 'user_preference',
      title: 'User Accesablity',
      description: 'Manage user preference from here.',
  ...
  useEffect(() => {
    //console.log('router.query.payment',router.query.payment)

    if (router.query.payment == `true`) {
      setActiveState('payment')
      toast.warn('Please add your payment info.', { toastId: 1 })
    }
