...
export default function NotFound() {
  return (
    <section class="bg-primary  relative z-10 py-[120px] min-h-screen flex flex-col justify-center">
        ...
        <div class="-mx-4 flex">
          <div class="w-full px-4">
            <div class="mx-auto max-w-[400px] text-center">
              ...
              <p class="mb-8 text-lg text-white">The page you are looking for may not exist !</p>
              <Link
                href="/"
