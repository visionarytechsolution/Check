...
const CheckoutForm = ({ amount, createOrder2, savePayInfo, selectedAddress, firstphoto,realtorImage }) => {
    ...
    <>
      <div className="lg:p-10 md:p-8 p-5 mt-10 bg-white  w-full border rounded-lg overflow-hidden">
        <form onSubmit={handleSubmit} className="mt-2">
          ...
          <OrderSummery selectedAddress={selectedAddress} firstphoto={firstphoto} realtorImage={realtorImage}/>
          <div className="mt-5">
            <Button
              name="Pay now"
              variant="contained"
